...
define(["angular", "common"], function (angular) {
    var mod = angular.module("place.services", ["fam.common"]);
    mod.factory("placeService", ["$http", "$q", "playRoutes", function ($http, $q, playRoutes) {
        var PlaceService = function () {
            var self = this;
            self.loadPlace = function (id) {
//                console.log("placeService.loadPlace", id);
            ...
            self.create = function (place) {
                return playRoutes.controllers.Places.post(JSON.stringify(place));
            };

            self.update= function (place) {
                return playRoutes.controllers.Places.update(place.id).post(JSON.stringify(place));
            };
